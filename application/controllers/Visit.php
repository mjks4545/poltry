...
class Visit extends CI_Controller {
	...
	public function index()
	{
       ...
       $data['serail_no']     = $this->m_home->get_serail_no();
       $data['visit_data']    = $this->m_home->get_visit_chicken_weight();
        //  echo '<pre>';
...
//----------------------------------------------------------------
  ...
  //----------------------------------------------------------------
        public function iamnewfunction(){
              ...
              $this->db->update('visit',[ 'balance' => $params['balance'] ]);
        ...
        public function get_serail_no(){
          ...
          print_r( $this->m_home->get_serail_no() );
        ...
        public function print_slip(){
           ...
           $empty_weight = $this->input->post('empty_weight');
           $loaded_weight = $this->input->post('loaded_weight');
           $chicken_weight = $this->input->post('chicken_weight');
           ...
           $data['print_data'] =array('visit_id' => $visit_id,
                                      'vehicle_number' =>$vehicle_number,
           ...
           $this->load->view('templates/header');
           $this->load->view('visit/design_view', $data);
           $this->load->view('templates/footer');
